// Generated on 2013-12-20 using generator-ngprise 0.1.0
'use strict';
		...
		tags: {
			server: {
				options: {
					...
					openTag: '<!-- start scripts tags -->',
					closeTag: '<!-- end scripts tags -->'
				},
				src:[
					'<%= yeoman.app %>/scripts/**/*.mdl.js',
					'<%= yeoman.app %>/scripts/**/*.js',
					'!<%= yeoman.app %>/scripts/**/*.mock.js',
					'!<%= yeoman.app %>/scripts/common/mocks/mock-utils.js',
					'!<%= yeoman.app %>/scripts/**/*.test.js',
					'!<%= yeoman.app %>/scripts/chrome/**/*.js',
					'!<%= yeoman.app %>/scripts/bower_components/**/*.js'
				],
...
//      server:{
//        files: {
//          "<%= yeoman.app %>/scripts/scripts.js": ["<%= yeoman.app %>/scripts/**/*.mdl.js",
//                                      "<%= yeoman.app %>/scripts/**/*.js",
//                                      "!<%= yeoman.app %>/scripts/**/*.test.js",
//                                      "!<%= yeoman.app %>/scripts/**/*.mock.js",
//	                                  "!<%= yeoman.app %>/scripts/scripts.js",
